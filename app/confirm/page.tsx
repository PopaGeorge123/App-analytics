...
export default async function ConfirmPage({ searchParams }: ConfirmPageProps) {
  ...
  if (result.status === "success") {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#fafafa] px-6 py-24">
        {/* Glow */}
        ...
        <div className="relative max-w-lg w-full text-center">
          ...
          <h1 className="mb-4 font-mono text-4xl font-bold text-[#1a1a2e] sm:text-5xl">
            You&apos;re in.&nbsp;🎉
          </h1>
          <p className="mb-10 text-base leading-relaxed text-[#4a4a6a]">
            Your spot is confirmed. We&apos;ll email you when Fold is ready for early access.
          </p>

          {/* Share prompt */}
          <div className="rounded-2xl border border-[#d4d4e8] bg-[#f2f2f8]/60 p-6 backdrop-blur-sm">
            <p className="mb-4 font-mono text-xs font-semibold uppercase tracking-wider text-[#6a6a90]">
              Know a founder who&apos;d love this?
            </p>
            <p className="mb-5 text-sm text-[#4a4a6a]">Share Fold with your network:</p>
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
              <a
                href={`https://twitter.com/intent/tweet?text=${shareText}&url=${shareUrl}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#d4d4e8] bg-[#e8e8f4] px-5 py-3 text-sm font-semibold text-[#1a1a2e] transition-all hover:border-[#00d4aa]/30 hover:bg-[#f0f8f4] hover:text-[#00d4aa]"
              >
          ...
          <div className="mt-10">
            <Link
              href="/"
              className="text-sm text-[#6a6a90] underline-offset-4 hover:text-[#4a4a6a] hover:underline"
            >
              ← Back to home
            </Link>
          </div>
    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#fafafa] px-6 py-24">
        <div className="max-w-lg w-full text-center">
          ...
          <h1 className="mb-4 font-mono text-3xl font-bold text-[#1a1a2e]">
            You&apos;re already on the list!
          </h1>
          <p className="mb-8 text-[#4a4a6a]">
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#fafafa] px-6 py-24">
      <div className="max-w-lg w-full text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-xl bg-[#00d4aa] px-6 py-3 text-sm font-semibold text-[#fafafa] transition-all hover:bg-[#00bfa0]"
        >
          Back to home
        </Link>
      </div>
