...
const FAQ_ITEMS = [
  ...
  { q: "What integrations do you support?", a: "Fold supports 50+ integrations across payments, analytics, advertising, e-commerce, email marketing, CRM, and social media. Live today: Stripe, Google Analytics 4, Meta Ads, Google Ads, Shopify, WooCommerce, Etsy, Mailchimp, Klaviyo, Beehiiv, Lemon Squeezy, Gumroad, Paddle, Plausible, PostHog, Hotjar, HubSpot, Instagram, X (Twitter), TikTok Ads, and more. Additional integrations are continuously being added." },
  ...
  { q: "What does the free plan include?", a: "The free plan gives you the full Overview dashboard — 6 KPI tiles, 7-day trends, recent activity feed, and quick actions — forever. The Premium plan unlocks deep per-platform analytics, the AI Advisor, the website optimizer, anomaly alerts, and the daily digest." },
  { q: "How much does Premium cost?", a: "Premium is $29/month. There's no annual lock-in — cancel any time. We also offer a free trial so you can see the full product before committing." },
