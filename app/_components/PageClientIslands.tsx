...
const FAQ_ITEMS = [
  ...
  { q: "Is there a free plan?", a: "There's no ongoing free tier — the full dashboard requires Premium. However, you can create a free account and get 7 days of full access completely free. No card required at any point during the trial. Upgrade to $29/month when you're ready." },
  { q: "How much does Premium cost?", a: "Premium is $29/month with no annual lock-in — cancel any time. New accounts get a 7-day free trial with full access to all premium features. No credit card required to start — just sign up and you're in." },
