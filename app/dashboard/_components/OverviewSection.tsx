...
const PLATFORM_METRICS: Record<string, MetricDef[]> = {
  ...
  ga4: [
    ...
    { field: "newUsers",    label: "New Users",    color: "#a78bfa", axis: "right", chartType: "bar",  formatType: "number",  aggregation: "sum" },
  ...
  plausible: [
    ...
    { field: "bounceRate",    label: "Bounce Rate",   color: "#fb923c", axis: "right", chartType: "line", formatType: "percent", aggregation: "avg" },
    { field: "visitDuration", label: "Avg Duration",  color: "#34d399", axis: "right", chartType: "line", formatType: "number",  aggregation: "avg" },
  ],
  posthog: [
    { field: "pageviews",   label: "Pageviews",    color: "#f76300", axis: "left",  chartType: "area", formatType: "number", aggregation: "sum" },
    { field: "uniqueUsers", label: "Unique Users", color: "#fb923c", axis: "left",  chartType: "line", formatType: "number", aggregation: "sum" },
  ...
  "lemon-squeezy": [
    ...
    { field: "netRevenue", label: "Net Revenue",  color: "#f59e0b", axis: "left",  chartType: "line", formatType: "currency", aggregation: "sum" },
    { field: "txCount",    label: "Transactions", color: "#a78bfa", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum" },
    { field: "fees",       label: "Fees",         color: "#f87171", axis: "right", chartType: "bar",  formatType: "currency", aggregation: "sum" },
  ],
  gumroad: [
    { field: "revenue",    label: "Revenue",      color: "#f87171", axis: "left",  chartType: "area", formatType: "currency", aggregation: "sum" },
    { field: "netRevenue", label: "Net Revenue",  color: "#fb923c", axis: "left",  chartType: "line", formatType: "currency", aggregation: "sum" },
    { field: "txCount",    label: "Transactions", color: "#00d4aa", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum" },
    { field: "fees",       label: "Fees",         color: "#f87171", axis: "right", chartType: "bar",  formatType: "currency", aggregation: "sum" },
  ],
  paddle: [
    { field: "revenue",    label: "Revenue",      color: "#38bdf8", axis: "left",  chartType: "area", formatType: "currency", aggregation: "sum"    },
    { field: "netRevenue", label: "Net Revenue",  color: "#22d3ee", axis: "left",  chartType: "line", formatType: "currency", aggregation: "sum"    },
    { field: "txCount",    label: "Transactions", color: "#60a5fa", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum"    },
    { field: "fees",       label: "Fees",         color: "#f87171", axis: "right", chartType: "bar",  formatType: "currency", aggregation: "sum"    },
  ],
  mailchimp: [
    { field: "subscribers", label: "Subscribers",  color: "#f59e0b", axis: "left",  chartType: "area", formatType: "number", aggregation: "sum"    },
    { field: "emailsSent",  label: "Emails Sent",  color: "#fbbf24", axis: "right", chartType: "bar",  formatType: "number", aggregation: "sum"    },
    { field: "opens",       label: "Opens",        color: "#34d399", axis: "right", chartType: "line", formatType: "number", aggregation: "sum"    },
    { field: "clicks",      label: "Clicks",       color: "#60a5fa", axis: "right", chartType: "line", formatType: "number", aggregation: "sum"    },
  ],
  klaviyo: [
    { field: "activeProfiles", label: "Active Profiles", color: "#00d4aa", axis: "left",  chartType: "area", formatType: "number",   aggregation: "latest" },
    { field: "emailsSent",     label: "Emails Sent",     color: "#34d399", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum"    },
    { field: "opens",          label: "Opens",           color: "#60a5fa", axis: "right", chartType: "line", formatType: "number",   aggregation: "sum"    },
    { field: "clicks",         label: "Clicks",          color: "#a78bfa", axis: "right", chartType: "line", formatType: "number",   aggregation: "sum"    },
    { field: "revenue",        label: "Revenue",         color: "#fbbf24", axis: "left",  chartType: "line", formatType: "currency", aggregation: "sum"    },
  ],
  beehiiv: [
    { field: "totalSubscribers",   label: "Subscribers",  color: "#FC5200", axis: "left",  chartType: "area", formatType: "number", aggregation: "latest" },
    { field: "newSubscribers",     label: "New Subs",     color: "#fb923c", axis: "right", chartType: "bar",  formatType: "number", aggregation: "sum"    },
    { field: "premiumSubscribers", label: "Premium Subs", color: "#a78bfa", axis: "left",  chartType: "line", formatType: "number", aggregation: "latest" },
    { field: "postsPublished",     label: "Posts",        color: "#34d399", axis: "right", chartType: "bar",  formatType: "number", aggregation: "sum"    },
  ],
  shopify: [
    { field: "revenue",      label: "Revenue",        color: "#96bf48", axis: "left",  chartType: "area", formatType: "currency", aggregation: "sum" },
    { field: "orders",       label: "Orders",         color: "#a3e635", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum" },
    { field: "newCustomers", label: "New Customers",  color: "#00d4aa", axis: "right", chartType: "line", formatType: "number",   aggregation: "sum" },
    { field: "refunds",      label: "Refunds",        color: "#f87171", axis: "right", chartType: "bar",  formatType: "number",   aggregation: "sum" },
  ],
  woocommerce: [
