...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-[#1e1e2e] bg-[#12121a] p-5 flex flex-col gap-3">
      <div className="flex items-start justify-between">
        <p className="font-mono text-[9px] uppercase tracking-widest text-[#4a4a6a]">{label}</p>
        {t && (
          <span className={`font-mono text-[10px] font-semibold ${t.up ? "text-[#00d4aa]" : "text-red-400"}`}>
