    ...
    <div className="min-h-screen bg-[#f5f5f8] text-[#1a1a2e]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-[#6a6a90]">
        ...
        <div className="prose-fold space-y-10">
          ...
          <Section title="13. Contact Us">
            ...
            <div className="rounded-xl border border-[#d4d4e8] bg-[#f2f2f8]/60 p-5 mt-4">
              ...
              <p className="text-sm text-[#4a4a6a] mt-0.5">Trading as: <span className="text-[#c8c8e0]">Fold Analytics</span></p>
      ...
      <footer className="border-t border-[#d4d4e8] px-6 py-8 mt-16">
        <div className="mx-auto max-w-4xl flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/terms" className="text-xs text-[#6a6a90] hover:text-[#4a4a6a] transition-colors">
              Terms of Service
            </Link>
          </nav>
        </div>
